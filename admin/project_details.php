  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="project_details.php" class="active">
      ...
      <section id="main-content">
          <section class="wrapper">
            <section class="panel">
                <header class="panel-heading text-danger"><b>Project Details of user</b></header>
                <div class="panel-body">
                    <table class="table table-bordered" id="pdDT">
                        ...
                        <tbody>
                            <?php  
                              $q1 = "select * from project_detail pd,reg_details rd where pd.reg_id=rd.reg_id order by reg_name asc";
                              $result = $con->query($q1);
                              $count=1;
