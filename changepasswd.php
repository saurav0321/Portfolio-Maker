...
<body class="align" style="background-color: #343a40;">
	<div class="grid">
    	...
    	<form action="update_passwd_process.php" method="post" class="form login">
    		<h1 class="text-info" style="margin-left: 5%">Change Password</h1>
        <?php 
      ...
      <?php 
          if (isset($_SESSION['pass-succ'])) {
         ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
          <?php echo $_SESSION['pass-succ']; ?> <br><hr>
          Want to login? <a href="index.php">Login Here</a>
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
          </button>
      </div>
      ...
      ?>
            ...
            <input id="newpasswd" type="password" name="newpasswd" class="form__input" placeholder="New Password" required="">
        </div>
        ...
        <div class="form__field">
            ...
            <input id="cnpasswd" type="password" name="cnpasswd" class="form__input" placeholder="Confirm Password" required="">
        </div>
