...
<section class="testimonial py-5" id="testimonial">
    <div class="container">
    	<form method="post" action="add_education_details.php" enctype="multipart/form-data">
	        <div class="row ">
		            ...
		            <div class="col-md-8 py-5 border">
		            	<?php  
		            		if (isset($_SESSION['ed_fail']))
		            		{
		            			
		            	?>
		            	<div class="alert alert-danger" role="alert">
  							<?php echo $_SESSION['ed_fail']; ?>
						</div>
						<?php 
							unset($_SESSION['ed_fail']);
						}
						?>
		                <h1 class="pb-4 text-warning">Educational Details</h1>
		                    ...
		                    <a href="experiance_details.php" class="text-primary">Click here to move next</a> <br><br>
		                    <div class="form-row">	
		                    ...
		                    <div class="form-row">
			                        ...
			                        <div class="col-md-12 form-group">
			                        	<input type="text" name="year" placeholder="Passing Year (eg. March 2020)" class="form-control" required="" maxlength="10">
									</div>
		                    </div>

		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="uni" placeholder="University/School Name" class="form-control" required="">
			                        </div>
			                        <div class="col-md-12 form-group">
			                        	<input type="text" name="grade" placeholder="Obtain Grades (eg. 8.0/10.0)" class="form-control" required="">
									</div>
		                    </div>
