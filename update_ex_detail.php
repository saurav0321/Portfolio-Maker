<?php 
	...
	$q = "select * from work_experiance_detail where we_id='$id'";
	$result = $con->query($q);
...
<section class="testimonial py-5" id="testimonial">
    <div class="container">
    	<form method="post" action="update_ex.php" enctype="multipart/form-data">
	        <div class="row ">
		            <div class="col-md-4 py-5 bg-primary text-white text-center ">
		                <div class=" ">
		                    <div class="card-body">
		                        <img src="img/logo.png" style="width:30%" title="PortFolioBox">
		                        <h2 class="py-3 text-warning">Work Experiance Details</h2>
		            ...
		            <div class="col-md-8 py-5 border">
		                ...
		                <h1 class="pb-4 text-warning">Work Experiance Details</h1>
		                    ...
		                    <div class="form-row">	
		                        ...
		                        <div class="form-row">
			                        ...
			                        <input type="hidden" name="we_id" value="<?php echo $r['we_id']; ?>">
		                    ...
		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="title" value="<?php echo $r['we_title']; ?>" class="form-control" placeholder="Experiance Title">
			                        </div>
			                        <div class="col-md-12 form-group">
			                        	<input type="text" name="comp" placeholder="Company Name" class="form-control" required="" value="<?php echo $r['we_comp']; ?>">
									</div>
		                    </div>

		                    <div class="form-row">
		                    	<div class="form-group col-md-12">
			                        <input type="text" name="dur" value="<?php echo $r['we_dur']; ?>" class="form-control" placeholder="Duration">
			                    </div>
			                    <div class="form-group col-md-12">
			                        <input type="text" name="ach" value="<?php echo $r['we_ach']; ?>" class="form-control" placeholder="Achievements">
			                    </div>
			                     <textarea class="form-control" placeholder="Details" name="desc"><?php echo $r['we_desc']; ?></textarea>
		                    </div>
