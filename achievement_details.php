...
<section class="testimonial py-5" id="testimonial">
    <div class="container">
    	<form method="post" action="add_achievement_details.php" enctype="multipart/form-data">
	        <div class="row ">
		            ...
		            <div class="col-md-8 py-5 border">
		            	<?php  
		            		if (isset($_SESSION['ach_fail']))
		            		{
		            			
		            	?>
		            	<div class="alert alert-danger" role="alert">
  							<?php echo $_SESSION['ach_fail']; ?>
						</div>
						<?php 
							unset($_SESSION['ach_fail']);
						}
						?>
		                <h1 class="pb-4 text-warning">Achievement Details</h1>
		                    ...
		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="ach_name" placeholder="Achievement Name" class="form-control" required="">
			                        </div>
			                         <div class="form-group col-md-12">
			                        	<input type="text" name="ach_rank" placeholder="Achievement Rank" class="form-control" required="">
			                        </div>
		                    ...
		                    <div class="form-row">
			                        <div class="form-group col-md-12">
			                        	<input type="text" name="ach_year" placeholder="Achievement year" class="form-control" required="">
			                        </div>
